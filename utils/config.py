...
argparser.add_argument('--vision_encoder_path', type=str, default='/mnt/data/wzh/ai_model/openai-clip-vit-base-patch16', help='openai/clip-vit-base-patch32 OR openai/clip-vit-large-patch14')
